...
public class TicketFenetre extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					TicketFenetre dialog = new TicketFenetre();
	 ...
	 * Create the dialog.
	 */
	public TicketFenetre() {
		getContentPane().setFocusTraversalKeysEnabled(false);

		// connect to database
		conn = new SQLiteCon();

		setIconImage(Toolkit.getDefaultToolkit().getImage(TicketFenetre.class.getResource("/view/logo_new.png")));
